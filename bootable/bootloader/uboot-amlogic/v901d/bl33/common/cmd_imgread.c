...
static int do_image_read_dtb(cmd_tbl_t *cmdtp, int flag, int argc, char * const argv[])
{
    ...
    char s_loadaddr[64] = {0};

    if (2 < argc) {
        loadaddr = (unsigned char*)simple_strtoul(argv[2], NULL, 16);
    }
    else{
	getenv_f("loadaddr", s_loadaddr, 64);
	loadaddr = (unsigned char*)simple_strtoul(s_loadaddr, NULL, 16);
    }
...
static int do_image_read_pic(cmd_tbl_t *cmdtp, int flag, int argc, char * const argv[])
{
    ...
    char s_loadaddr[64] = {0};
    getenv_f("loadaddr_misc", s_loadaddr, 64);

    loadaddr = (unsigned char*)simple_strtoul(argc > 3 ? argv[3] : s_loadaddr, NULL, 16);
...
static int do_unpackimg(cmd_tbl_t *cmdtp, int flag, int argc, char * const argv[])
{
    ...
    char s_loadaddr[64] = {0};
    getenv_f("loadaddr_misc", s_loadaddr, 64);
    loadaddr = (unsigned char*)simple_strtoul(argc > 1 ? argv[1] : s_loadaddr, NULL, 16);
