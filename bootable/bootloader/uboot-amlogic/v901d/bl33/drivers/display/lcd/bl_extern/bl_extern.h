...
extern int i2c_m0516ldn_probe(void);
extern int i2c_m0516ldn_power_on(void);
extern int i2c_m0516ldn_power_off(void);
extern int i2c_m0516ldn_set_level(unsigned int level);
extern int i2c_serdes_0_probe(int* des_id);
extern int i2c_serdes_1_probe(int* des_id);
extern int i2c_a8552_probe(void);
extern int i2c_a8552_power_on(void);
extern int i2c_a8552_power_off(void);
extern int i2c_a8552_set_level(unsigned int level);
#endif
