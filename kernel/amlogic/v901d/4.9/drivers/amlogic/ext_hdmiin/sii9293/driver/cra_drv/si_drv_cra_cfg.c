...
// Index to this array is the virtual page number in the MSB of the REG_xxx
// address values Indexed with uint32_t value shifted right 8 bits
// DEV_PAGE values must correspond to the order specified in the
// uint32_t enum list
struct pageConfig_t
	g_addrDescriptor[SII_CRA_MAX_DEVICE_INSTANCES]
	[SII_CRA_DEVICE_PAGE_COUNT] = {
		...
		{DEV_I2C_2, DEV_PAGE_PP_9}, // Video RGB2xvYCC Reg and rvs
		// control / VSI control and status
		...
		{DEV_I2C_2_OFFSET,
			0x0000 + DEV_PAGE_AUDIO}, // Audio Extraction instance 1
		}
		...
		{DEV_I2C_0, DEV_PAGE_PP_9}, // Video RGB2xvYCC Reg and rvs
		// control / VSI control and status
...
SiiReg_t g_siiRegPageBaseReassign[] = {
	// PP_PAGE_3 | 0xFC,// Example of changing default page 3
	// device ID (0xFA) to 0xFC
