...
enum {
	...
	MHL_MSC_MSG_INEFFECTIVE_KEY_CODE =
	    0x01, // The key code in the RCP sub-command is not recognized
...
enum {
	...
	MHL_MSC_MSG_UCP_INEFFECTIVE_KEY_CODE =
	    0x01, // The key code in the UCP sub-command is not recognized
};
