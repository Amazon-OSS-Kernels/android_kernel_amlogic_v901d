...
// Index into struct pageConfig_t array (shifted left by 8)
enum {
	...
	PP_PAGE_9 = 0x0900, // Video RGB2xvYCC Reg and rvs control / VSI control
			    // and status
...
#define SII_CRA_MAX_DEVICE_INSTANCES                                           \
	1 // Maximum size of instance dimension of address descriptor array
#define SII_CRA_DEVICE_PAGE_COUNT 16
// Number of entries in struct pageConfig_t array

struct pageConfig_t {
	uint32_t busType; // I2C, Parallel
