...
ROM const struct videoMode_t VideoModeTable[NMB_OF_VIDEO_MODES + 1] = {
	//{VIC, HVIC {H/V active}, {H/V  total},
    //{H/V blank),{HVSyncO}, {HVSyncW},Fh
	//, Fv , Fpix, Pclk, I/P , HPol, VPol, syst, repetition ,audio},
	...
	{0,
	 ...
	 PAL,
	 RP1,
	 192}, // H-pos, V-neg, 1,2 blanks are same = 85
	{0,
	 40,
	 0,
	 {1920, 1080},
	...
	{0,
	 ...
	 0,
	 RP1,
	 192}, // SMPTE (cannot be distinguished from #3)
...
// It is not clear from CEA861C, where it is said at one place that
// formats 10...13 and 25...28 could have repetition factors 4,5,7,8,10, but at
// the table 12 on page 76 it is said that the factor could be any in 1...10
// range...

ROM const uint8_t ceaVicToVideoTableIndex[LAST_KNOWN_CEA_VIC + 1] = {
	NMB_OF_CEA861_VIDEO_MODES, // no VIC (dummy,
	// to start real indexes from 1,
	// but not from 0)
	0,			       // VIC=1
	1,			       // VIC=2
	1,			       // VIC=3
