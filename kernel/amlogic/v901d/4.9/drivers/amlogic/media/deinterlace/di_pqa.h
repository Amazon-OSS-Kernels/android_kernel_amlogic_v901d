...
#define DI_IC_ID_T5		(0x20)//(0x19)// same with tm2b
#define DI_IC_ID_T5D		(0x21) // new for verA
#define DI_IC_ID_T5DB		(0x22)//(0x1A)// same with tm2b

#define DI_IC_ID_SC2		(0x25)//(0x1B)
#define DI_IC_ID_T7		(0x2a)//(0x1C)
