 ...
 */
#define VDIN_VER "ver:2021-0105: ioctrl viuloop add port"
...
struct vdin_para_to_enc_s {
	...
	/* buffer y data line stride, for alignment referrer to pitch in
	 * AMVEncFrameIO
	*/
	unsigned int width_stride;
	/* size limit of the buffer it shall large enough to hold the whole
	 * frame
	*/
