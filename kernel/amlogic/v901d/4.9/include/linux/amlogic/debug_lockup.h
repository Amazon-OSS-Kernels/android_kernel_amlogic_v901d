...
void tasklet_in_hook(unsigned int cpu, unsigned long long *tin, void *p);
void tasklet_out_hook(unsigned int cpu, unsigned long long tin, void *p);
void timer_in_hook(unsigned int cpu, unsigned long long *tin, void *p);
void timer_out_hook(unsigned int cpu, unsigned long long tin, void *p);
