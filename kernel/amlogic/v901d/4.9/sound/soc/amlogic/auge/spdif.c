...
int spdifout_valid_bit_get_enum(
	struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	ucontrol->value.enumerated.item[0] = get_spdifout_valid_bit(SPDIF_A);

	return 0;
}

int spdifout_valid_bit_set_enum(
	struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	int val = ucontrol->value.enumerated.item[0];

	set_spdifout_valid_bit(SPDIF_A, val);
...
static const struct snd_kcontrol_new snd_spdif_controls[] = {
	...
	SOC_SINGLE_BOOL_EXT("Audio spdifout valid bit",
				0,
				spdifout_valid_bit_get_enum,
				spdifout_valid_bit_set_enum),
};
